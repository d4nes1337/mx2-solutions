...
// and ADR-0002 (Deposit Wallet on Polygon) are pinned to it. Base/Arbitrum/
// Ethereum exist ONLY for bridge-funding sends ("send USDC from your wallet on
// Base"): sign-in and all trading flows stay on 137. MetaMask (injected) works
// with the placeholder projectId; WalletConnect needs a real id from
// cloud.walletconnect.com.
export const wagmiConfig = getDefaultConfig({
  appName: "MX2 Terminal",
  projectId: process.env.NEXT_PUBLIC_WALLETCONNECT_PROJECT_ID ?? "MX2_LOCAL_DEV_PLACEHOLDER",
  chains: [polygon, base, arbitrum, mainnet],
  transports: {
